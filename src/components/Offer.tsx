...
const Offer = () => {
  ...
  return <section className="bg-card">
      <div className="max-w-6xl mx-auto px-6 py-20 md:py-28 text-center">
        ...
        <button onClick={() => scrollTo("footer")} className="px-8 py-3.5 rounded-md bg-orange text-navy font-heading font-semibold text-base hover:opacity-90 transition-opacity">
          Book a Call
        </button>
      </div>
    </section>;
