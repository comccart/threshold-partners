  ...
  return (
    <section className="bg-card">
      <div className="max-w-6xl mx-auto px-6 py-20 md:py-28 text-center">
        ...
        <p className="font-heading font-medium text-lg text-muted-foreground mb-14">6-Month Engagement</p>

        <div className="grid md:grid-cols-3 gap-8 mb-14">
          {phases.map((phase) => {
            const s = accentStyles[phase.accent];
            return (
              <div key={phase.period} className={`bg-cream rounded-xl p-8 border-t-4 ${s.border} text-left`}>
