const LeadMagnet = () => {
  return (
    <section id="lead-magnet" className="bg-card">
      <div className="max-w-4xl mx-auto px-6 py-20 md:py-28 text-center">
        <h2 className="font-heading font-bold text-3xl md:text-4xl text-navy mb-2">
          The Leadership Gap
        </h2>
        <p className="font-heading font-medium text-lg text-chestnut mb-6">
          An A–Z of What Breaks When AI Enters Your Organization
        </p>
